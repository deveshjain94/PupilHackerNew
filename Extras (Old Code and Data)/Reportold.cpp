...
font1 = HPDF_GetFont (pdf, "Helvetica", NULL);  //Declaring Font for template 
    ...
    for (i=3; i<11;i++){
   	HPDF_Page_SetFontAndSize (page1, font1, 10);
        ...
        HPDF_Page_MoveTextPos (page1, 11+i*CELL_WIDTH+5, CELL_TOP-11);
        HPDF_Page_ShowText (page1,"Stimulus ");
        HPDF_Page_EndText (page1);
        
        HPDF_Page_BeginText (page1);							//Printing stimulus no.
        snprintf(buf, 5, "%X", i-2);
        HPDF_Page_MoveTextPos (page1, 11+i*CELL_WIDTH+45, CELL_TOP-11);
...
pdf = HPDF_NewEx (error_handler, NULL, NULL, 0, NULL);
	...
	HPDF_Page_DrawImage (page1, image1, 20,735,90,70);
        ...
        HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,50,215);				//Remarks :
        ...
        HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,11,38);				//Legend 1
        HPDF_Page_ShowText (page1,"OD : Right Eye                                 OS : Left Eye");
        HPDF_Page_EndText (page1);
        
        HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,335,38);				//Legend 2
        HPDF_Page_ShowText (page1,"T1 : Rise Time                                 T2 : Recovery Time");
        HPDF_Page_EndText (page1);
        
        HPDF_Page_SetFontAndSize (page1, font, 10);
        HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,11,20);				//Legend 2
        HPDF_Page_ShowText (page1,"Lux Values :");
        HPDF_Page_EndText (page1);
...
t1s=tim[minj]-t;			
	...
	HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,11+CELL_WIDTH/2-8+(i1+3)*CELL_WIDTH, CELL_TOP-5*CELL_HEIGHT-11);
        HPDF_Page_ShowText (page1,times);
        HPDF_Page_EndText (page1);
...
cout<<t1d<<"\n";
	...
	HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,11+CELL_WIDTH/2-8+(i1+3)*CELL_WIDTH, CELL_TOP-CELL_HEIGHT-11);
        HPDF_Page_ShowText (page1,times);
        HPDF_Page_EndText (page1);
...
HPDF_Page_DrawImage (page1, image, 30,250,535,200);

	HPDF_Page_SetFontAndSize (page1, font, 10);
        HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,275,240);				//Time Axis
        HPDF_Page_ShowText (page1,"Time (ms)");
        HPDF_Page_EndText (page1);
        
        HPDF_Page_BeginText (page1);
        HPDF_Page_MoveTextPos (page1,260,230);				//Radius Axis
    	HPDF_Page_SetTextMatrix (page1, cos(rad), sin(rad), -sin(rad), cos(rad),40, 330);
    	HPDF_Page_ShowText (page1,"Radius (px)");
        HPDF_Page_EndText (page1);
